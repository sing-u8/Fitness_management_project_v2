...
// html 파일에서 <ng-container [ngTemplateOutlet]="idleRef.templateRef"></ng-container> 와 비슷한 부분 참고
// 해당 ts 파일에서 @ContentChild(IconButtonIdleContentDirective) idleRef!: IconButtonPendingContentDirective 와 비슷한 부분 참고 부분 참고
