...
describe('ButtonComponent', () => {
    ...
    it('button should set Input', () => {
        ...
        expect(buttonEl.style.width).withContext('should equal to input width').toEqual(`${inputObj.width}px`)
        expect(buttonEl.style.height).withContext('should equal to input height').toEqual(`${inputObj.height}px`)
